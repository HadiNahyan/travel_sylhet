...
class _TravelState extends State<Travel> {
  List<String> travTitle=["শাহজালাল (রহঃ) মাজার","শাহপরান (রহঃ) মাজার","জাফলং","বিছনাকান্দি পান্থুমাই\nও লক্ষনছড়া",
          ...
          actions: [
            TextButton(onPressed: (){
               Navigator.of(context).push(MaterialPageRoute(builder: (context)=>Hotel()));
                ...
                color: Colors.yellowAccent,decoration: TextDecoration.underline,
              fontSize: 16,
                            ...
                            Column(
                              children: [
                               ...
                               // ),
                                ...
                                child:  Text(travTitle[i],style: TextStyle(
                                      color: Colors.white,fontWeight: FontWeight.bold),
...
class _JafState extends State<Trav> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(name.title,style: TextStyle(fontSize: 18),),
        actions: [
...
//   _FavState({required this.title});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Favourite Spots"),),
...
class FavScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(head,style: TextStyle(fontSize: 18),),
      ),
      body: ListView(
        children: [
          Column(
